 ...
 *
 */
var paper = function (w, R) {
  var T = (w = w || require("./node/self.js")).window,
    A = w.document,
    j = new (function () {
      function n(t, e, n) {
        var i;
  ...
  "undefined" != typeof module && (module.exports = j),
    j.inject(
      {
        enumerable: !1,
        toString: function () {
        ...
        importJSON: function (t) {
          return j.importJSON(t, this);
        },
        exportJSON: function (t) {
          return j.exportJSON(this, t);
        },
        toJSON: function () {
          return j.serialize(this);
        },
        set: function (t, e) {
          return t && j.filter(this, t, e, this._prioritize), this;
        },
      },
      {
        beans: !1,
        statics: {
          ...
          extend: function t() {
            ...
            return n && !j.exports[n] && (j.exports[n] = e), e;
          },
          equals: function (t, e) {
            if (t === e) return !0;
            ...
            if (t && e && "object" == typeof t && "object" == typeof e) {
              if (Array.isArray(t) && Array.isArray(e)) {
                ...
                for (; n--; ) if (!j.equals(t[n], e[n])) return !1;
              } else {
                var n,
                  i = Object.keys(t);
                ...
                for (; n--; ) {
                  var r = i[n];
                  if (!e.hasOwnProperty(r) || !j.equals(t[r], e[r])) return !1;
                }
              }
              return !0;
            }
              ...
              e instanceof this || (n && n.readNull && null == e && i <= 1)
                ...
                : ((e = j.create(s)),
                  ...
                  (e =
                    e.initialize.apply(
                      e,
                      0 < o || o + i < r ? j.slice(t, o, o + i) : t
                    ) || e),
                  a &&
                    ((t.__index = o + e.__read),
                    (o = e.__filtered) &&
                      ((t.__filtered = o), (e.__filtered = R)),
                    (e.__read = R)),
                  e)
            );
          },
          ...
          readNamed: function (t, e, n, i, r) {
            ...
            return (
              h &&
                ((a = t.__filtered) ||
                  ((s = this.getSource(t)),
                  ((a = t.__filtered = j.create(s)).__unfiltered = s)),
                (a[e] = R)),
          ...
          getSource: function (t) {
            ...
            return (
              n === R &&
                ((e = 1 === t.length && t[0]),
                (n = t.__source = e && j.isPlainObject(e) ? e : null)),
              n
            );
          },
          ...
          deserialize: function (t, e, n, i, r) {
            ...
            if (((n = n || {}), Array.isArray(t))) {
              ...
              s = [];
              for (
                var l, c = (h = j.exports[h]) ? 1 : 0, f = t.length;
                c < f;
                c++
              )
                s.push(j.deserialize(t[c], e, n, u, o));
              h && ((l = s), (s = e ? e(h, l, a || r) : new h(l)));
            } else if (j.isPlainObject(t))
              for (var d in ((s = {}), i && (n.dictionary = s), t))
                s[d] = j.deserialize(t[d], e, n);
            return o ? s[1] : s;
          },
            ...
            return j.deserialize(
              ...
              function (t, e, n) {
                var i = n && s && s.constructor === t,
                  r = i ? s : j.create(t.prototype);
                return (
                  !(1 === e.length && r instanceof V) ||
                    (!i && r instanceof a) ||
                    ((n = e[0]),
                    j.isPlainObject(n) &&
                      ((n.insert = !1), i && (e = e.concat([V.INSERT])))),
                  (i ? r.set : t).apply(r, e),
                  i && (s = null),
                  r
                );
  ...
  var t = {
    ...
    l = j.extend({
      ...
      install: function (e) {
        var t,
          n = this;
        for (t in (j.each(["project", "view", "tool"], function (t) {
          j.define(e, t, {
            configurable: !0,
            get: function () {
              return n[t];
    ...
    e = j.extend(t, {
      ...
      remove: function () {
        return (
          null != this._index &&
          (j.splice(this._scope[this._list], null, this._index, 1),
            ...
            if ((p.splice(0, S), s && r))
              ...
              for (var I = y[d], P = y[f], k = 0; k < p.length; k++) {
                var T = p[k],
                  ...
                  O = s || o <= T;
                (r ||
                  (((x && O) || (b && M)) && I >= A[f] - n && P <= A[d] + n)) &&
                  (x && O && C.push(s ? T : T - o), b && M && v[T].push(w));
              }
          }
  ...
  var q = new (function () {
    ...
    b = j.extend(
      {
          ...
          "number" == c
            ...
            : 1 === l.length &&
              (Array.isArray(t)
                ...
                : t.from === R &&
                  t.to === R &&
                  (this._set(0, 0, 0, 0), j.readSupported(l, this) && (r = 1))),
            r === R &&
              ((a = E.readNamed(l, "from")),
              (s = j.peek(l)),
              (c = a.x),
              (a = a.y),
              (s && s.x !== R) || j.hasNamed(l, "to")
        ...
        equals: function (t) {
          var e = j.isPlainValue(t) ? b.read(arguments) : t;
          return (
            e === this ||
            (e &&
              this.x === e.x &&
        ...
        scale: function (t, e) {
          return this.expand(
            ...
            this.height * (e === R ? t : e) - this.height
          );
        },
      },
      j.each(
    ...
    z = j.extend(
      {
        ...
        _serialize: function (t, e) {
          return j.serialize(this.getValues(), t, !0, e);
        },
        _changed: function () {
          var t = this._owner;
        ...
        apply: function (t, e) {
          var n = this._owner;
          return (
            !!n && (n.transform(null, j.pick(t, !0), e), this.isIdentity())
          );
        },
        translate: function () {
          var t = E.read(arguments),
    ...
    i = e.extend({
      ...
      _serialize: function (t, e) {
        return j.serialize(this._children, t, !0, e);
      },
      ...
      _insertItem: function (t, e, n) {
        return (
          (e =
            ...
            (
              this._activeLayer || this._insertItem(R, new a(V.NO_INSERT), !0)
            ).insertChild(t, e)),
      ...
      importJSON: function (t) {
        ...
        return j.importJSON(t, e && e.isEmpty() && e);
      },
      removeOn: function (t) {
    ...
    V = j.extend(
      ...
      })(),
      {
        ...
        _initialize: function (t, e) {
          ...
          return (
            ...
            i ||
            (n && 0 == t.insert) ||
            (!a.insertItems && (!n || 1 != t.insert))
              ? this._setProject(s)
              : ((n && t.parent) || s)._insertItem(R, this, !0),
            n &&
              t !== V.NO_INSERT &&
              t !== V.INSERT &&
              this.set(t, {
        ...
        _serialize: function (i, r) {
          ...
          function t(t) {
            for (var e in t) {
              var n = a[e];
              j.equals(n, "leading" === e ? 1.2 * t.fontSize : t[e]) ||
                (s[e] = j.serialize(n, i, "data" !== e, r));
            }
          }
          return (
        ...
        _changed: function (t) {
          var e = this._symbol,
            n = this._parent || e,
            i = this._project;
          8 & t && (this._bounds = this._position = this._decomposed = R),
            16 & t && (this._globalMatrix = R),
        ...
        },
        {
          ...
          getBounds: function (t, e) {
            var n = e || t instanceof z,
              i = j.set({}, n ? e : t, this._boundsOptions);
      ...
      },
      {
        ...
        _equals: function (t) {
          return j.equals(this._children, t._children);
        },
        clone: function (t) {
          var e = new this.constructor(V.NO_INSERT),
            n = this._children,
            i = j.pick(t ? t.insert : R, t === R || !0 === t),
            t = j.pick(t ? t.deep : R, !0);
        ...
        copyAttributes: function (t, e) {
          ...
          var a = t._data,
            e = t._name;
          (this._data = a ? j.clone(a) : null), e && this.setName(e);
        },
        rasterize: function (t, e) {
          ...
          j.isPlainObject(t)
            ...
            : ((a = t), (n = e));
          var i = i || new c(V.NO_INSERT),
            r = this.getStrokeBounds(),
          ...
          return (
            ...
            r.isZero() ||
              ...
              e.save(),
              r.applyToContext(e),
              this.draw(e, new j({ matrices: [r] })),
              e.restore()),
            i._matrix.set(new z().translate(t.add(a.divide(2))).scale(1 / s)),
            (n !== R && !n) || i.insertAbove(this),
            i
          );
        },
        contains: function () {
      ...
      new (function () {
        function t() {
          var t = arguments;
          return this._hitTest(E.read(t), M.getOptions(t));
        }
        function e() {
          var t = arguments,
            e = E.read(t),
            n = M.getOptions(t),
            t = [];
          return this._hitTest(e, new j({ all: t }, n)), t;
        }
        function n(t, e, n, i) {
      ...
      })(),
      {
        _hitTest: function (i, e, t) {
          ...
          var o,
            ...
            u = !(
              ...
              (e.type && e.type !== j.hyphenate(this._class)) ||
          ...
          function d(t, e) {
            ...
            if (i.subtract(n).divide(a).length <= 1)
              return new M(t, c, { name: e ? j.hyphenate(e) : t, point: n });
          }
          var _ = e.position,
            t = e.center,
            s = e.bounds;
        ...
        matches: function (t, e) {
          ...
          n = /^(empty|editable)$/.test(t)
            ? this["is" + j.capitalize(t)]()
            : "type" === t
            ? j.hyphenate(this._class)
            : this[t];
          if ("class" === t) {
              ...
              return (function t(e, n) {
                for (var i in e)
                  if (e.hasOwnProperty(i)) {
                    var r = e[i],
                      i = n[i];
                    if (j.isPlainObject(r) && j.isPlainObject(i)) {
                      if (!t(r, i)) return !1;
                    } else if (!j.equals(r, i)) return !1;
                  }
                return !0;
              })(e, n);
          }
      ...
      },
      {
        ...
        insertChildren: function (t, e) {
          var n = this._children;
          if (n && e && 0 < e.length) {
            for (var i = {}, r = (e = j.slice(e)).length - 1; 0 <= r; r--) {
              var s = (u = e[r]) && u._id;
        ...
        removeChildren: function (t, e) {
          ...
          (t = t || 0), (e = j.pick(e, this._children.length));
          for (
            var n = j.splice(this._children, null, t, e - t), i = n.length - 1;
            0 <= i;
            i--
          )
            n[i]._remove(!0, !1);
      ...
      j.each(
        ["down", "drag", "up", "move"],
        function (e) {
          this["removeOn" + j.capitalize(e)] = function () {
            var t = {};
    ...
    g = V.extend({
      ...
      _changed: function t(e) {
        t.base.call(this, e), 2050 & e && (this._clipItem = R);
      },
      _getClipItem: function () {
        if ((t = this._clipItem) === R) {
          for (
    ...
    d = V.extend(
      {
        ...
        _equals: function (t) {
          return (
            ...
            j.equals(this._radius, t._radius)
          );
        },
        copyContent: function (t) {
        ...
        toPath: function (t) {
          var e = new W[j.capitalize(this._type)]({
            center: new E(),
            size: this._size,
            radius: this._radius,
            insert: !1,
      ...
      })(),
      {
        statics: new (function () {
          function i(t, e, n, i, r) {
            var s = j.create(d.prototype);
            return (
              (s._type = t),
              (s._size = n),
              (s._radius = i),
              s._initialize(j.getNamed(r), e),
              s
            );
          }
          return {
    ...
    c = V.extend(
      {
        ...
        initialize: function (t, e) {
          var n, i;
          this._initialize(t, e !== R && E.read(arguments)) ||
            ((i =
              "string" == (i = typeof t)
                ? A.getElementById(t)
                : "object" == i
      ...
      },
      {
        ...
        getAverageColor: function (t) {
          ...
          var i = new z()
            ...
            .translate(-i.x, -i.y);
          i.applyToContext(t),
            r && r.draw(t, new j({ clip: !0, matrices: [i] })),
    ...
    s = V.extend({
      ...
      initialize: function (t, e) {
        this._initialize(t, e !== R && E.read(arguments, 1)) ||
    ...
    p = j.extend({
      ...
      _serialize: function (t, e) {
        return e.add(this, function () {
          return j.serialize([this._class, this._item], t, !1, e);
        });
      },
      _changed: function (t) {
    ...
    U = j.extend({
      ...
      _serialize: function (t, e) {
        ...
        return i && n.push(i), j.serialize(n, t, !0, e);
      },
      _changed: function (t) {
        var e,
          n,
    ...
    f = E.extend({
      initialize: function (t, e, n) {
        ...
        t
          ? (i = t[0]) !== R
            ? (r = t[1])
            : ((i = (s = t).x) === R && (i = (s = E.read(arguments)).x),
              (r = s.y),
              (s = s.selected))
          : (i = r = 0),
          (this._x = i),
    ...
    H = j.extend(
      ...
      },
      {
        ...
        divide: function (t, e) {
          return this.divideAtTime(t === R ? 0.5 : e ? t : this.getTimeAt(t));
        },
        split: function (t, e) {
          return this.splitAtTime(t === R ? 0.5 : e ? t : this.getTimeAt(t));
        },
        reversed: function () {
        ...
        return {
          statics: {
            ...
            getLength: function (t, e, n, i) {
              if ((e === R && (e = 0), n === R && (n = 1), H.isStraight(t))) {
                var r = t;
      ...
      new (function () {
                  ...
                  0.8 < _ - d
                    ? u < l - S
                      ? ((h = O(
                        ...
                        O(e, T[1], i, n, r, s, !a, o, h, c, f, P, l))
                      : ((h = O(
                          (T = H.subdivide(e, 0.5))[0],
                          t,
                          i,
                          n,
                          r,
              ...
              if (
                ((_
                  ? function (t, e, n, i, r, s) {
                      ...
                      a && M(r, s, n, H.getTimeOf(t, a), i, H.getTimeOf(e, a));
                    }
                  : f || d
        ...
        function b(t, e, n, i) {
          t = H.classify(t);
          return "loop" === t.type && M(n, i, e, (t = t.roots)[0], e, t[1]), n;
        }
        function w(t, e) {
          function n(t) {
            var e = t[6] - t[0],
    ...
    W = _.extend(
      {
        ...
        _equals: function (t) {
          return (
            this._closed === t._closed && j.equals(this._segments, t._segments)
          );
        },
        copyContent: function (t) {
        ...
        _changed: function t(e) {
          if ((t.base.call(this, e), 8 & e)) {
            if (((this._length = this._area = R), 32 & e)) this._version++;
            else if (this._curves)
              for (var n = 0, i = this._curves.length; n < i; n++)
                this._curves[n]._changed();
          } else 64 & e && (this._bounds = R);
        },
        getStyle: function () {
          var t = this._parent;
      ...
      },
      {
        ...
        removeSegments: function (t, e, n) {
          (t = t || 0), (e = j.pick(e, this._segments.length));
        ...
        split: function (t, e) {
          e = e === R ? t : (t = this.getCurves()[t]) && t.getLocationAtTime(e);
        ...
        smooth: function (t) {
          ...
          if (
            ...
            if (
              ...
              (x[f] = (3 * _[f]._x - x[v]) / 2),
                (b[f] = (3 * _[f]._y - b[v]) / 2);
              for (var g = d, M = f - t, p = h; g <= M; g++, p++) {
                var O = n[p < 0 ? p + s : p],
                  z = O._point,
                  E = x[g] - z._x,
                  z = b[g] - z._y;
                (o || g < M) && O.setHandleOut(E, z),
          ...
          function b(t, e, n) {
            if (!r.selected || e.isSelected()) {
              ...
              if (x((e = e !== i ? e.add(i) : e), p))
                return new M(n, l, { segment: t, point: e });
            }
          }
          function C(t, e) {
            return (
        ...
        return {
          ...
          arcTo: function () {
            var t,
              ...
              a = E.read(e),
              o = j.peek(e);
            if ("boolean" == typeof (f = j.pick(o, !0)))
              var h = (_ = s.add(a).divide(2)).add(
                _.subtract(s).rotate(f ? -90 : 90)
              );
            else if (j.remain(e) <= 2) (h = a), (a = E.read(e));
            else if (!s.equals(a)) {
              var u = O.read(e),
                l = q.isZero;
                ...
                I < b &&
                  ...
                  t
                    ? ((T = t._transformPoint(x)),
                      (A = t._transformPoint(x.add(A)).subtract(T)))
                    : (T = w.add(x))),
                  I
                    ? ((P = x.rotate(-90).multiply(S)),
                      t && (P = t._transformPoint(x.add(P)).subtract(T)),
                      k.push(new U(T, P, A)))
                    : r.setHandleOut(A),
                  (x = x.rotate(C));
              }
  ...
  W.inject({
    statics: new (function () {
      ...
      function l(t, e, n) {
        var i = j.getNamed(n),
          n = new W(
            i && (1 == i.insert ? V.INSERT : 0 == i.insert ? V.NO_INSERT : null)
          );
      ...
      return {
        ...
        Star: function () {
          for (
            var t = arguments,
              e = E.readNamed(t, "center"),
              n = 2 * j.readNamed(t, "points"),
              i = j.readNamed(t, "radius1"),
              r = j.readNamed(t, "radius2"),
              s = 360 / n,
              a = new E(0, -1),
              o = new Array(n),
              h = 0;
  ...
  var $ = _.extend(
    {
      ...
      insertChildren: function t(e, n) {
        ...
        for (var s = n.length - 1; 0 <= s; s--) {
          var a = i[s];
          i !== n || a instanceof W || (i = j.slice(i)),
            Array.isArray(a)
      ...
      _hitTestChildren: function t(e, n, i) {
        return t.base.call(
          this,
          e,
          n.class === W || "path" === n.type ? n : j.set({}, n, { fill: !1 }),
          i
        );
      },
      _draw: function (t, e, n, i) {
      ...
      function n(t, e, n, i) {
        ...
        function f(t) {
          for (var e = 0, n = t.length; e < n; e++) {
            var i = t[e];
            j.push(l, i._segments),
              j.push(c, i.getCurves()),
              (i._overlapsOnly = !0);
          }
        }
        function d(t) {
        ...
        if (h.length) {
          ...
          o = M(n ? u.concat(n) : u.slice(), function (t) {
            return !!a[t];
          });
        return I(o, !0, t, e, i);
      }
      ...
      function N(u, l, c, f, d) {
        ...
        for (var o = 0, h = e.length; o < h; o++) {
          ...
          if (
            ...
            for (var A = T, M = P.getLastCurve(); M && M !== I; ) {
              var O = M.getValues();
              if (O[g] !== O[g + 6]) {
                A = O;
                break;
  ...
  var m = j.extend(
    ...
    v = V.extend({
      ...
      initialize: function (t) {
        ...
        var e = t && j.isPlainObject(t) && t.x === R && t.y === R;
      ...
      new (function () {
        ...
        return j.each(
          ...
          },
          {
            ...
            initialize: function t(e) {
              ...
              if (
                ("string" === o &&
                  ...
                  Array.isArray(e)
                    ? ((n = e), (l = r[2]))
                    : (s && (a = 1), (r = j.slice(r, 1)), (o = typeof e))),
                !n)
              ) {
                if (
                  (i =
            ...
            equals: function (t) {
              var e = j.isPlainValue(t, !0) ? C.read(arguments) : t;
              return (
                e === this ||
                (e &&
                  ...
                  j.equals(this._components, e._components)) ||
                !1
              );
            },
            toString: function () {
    ...
    S = j.extend({
      ...
      initialize: function (t, e) {
        (this._id = o.get()),
          t && j.isPlainObject(t) && (this.set(t), (t = e = null)),
      ...
      _serialize: function (t, e) {
        return e.add(this, function () {
          return j.serialize([this._stops, this._radial], t, !0, e);
        });
      },
      _changed: function () {
      ...
      _removeOwner: function (t) {
        ...
        -1 != t &&
          ...
          this._owners.length || (this._owners = R));
      },
      clone: function () {
      ...
      setStops: function (t) {
        ...
        var e = this._stops;
        if (e) for (var n = 0, i = e.length; n < i; n++) e[n]._owner = R;
        for (
    ...
    k = j.extend({
      ...
      _serialize: function (t, e) {
        var n = this._color,
          i = this._offset;
        return j.serialize(null == i ? [n] : [n, i], t, !0, e);
      },
      _changed: function () {
        ...
        equals: function (t) {
          function e(t, e, n) {
            ...
            for (i in r) {
              var o = r[i],
                h = s[i];
              if (!((n && i in s) || j.equals(o, h === R ? a[i] : h)))
                return !1;
            }
            return !0;
          }
  ...
  N.requestAnimationFrame = new (function () {
    var e,
      i = P.getPrefixed(T, "requestAnimationFrame"),
      r = !1,
      s = [];
    function a() {
      var t = s;
  ...
  var B,
      ...
      t,
      {
        ...
        _handleFrame: function () {
          ...
          (this._last = t),
            this.emit(
              "frame",
              new j({ delta: e, time: (this._time += e), count: this._count++ })
            ),
        ...
        _handleFrameItems: function (t) {
          for (var e in this._frameItems) {
            ...
            e.item.emit(
              "frame",
              new j(t, { time: (e.time += t.delta), count: e.count++ })
            );
          }
        },
        _changed: function () {
      ...
      function s(t) {
        var e = t.key || t.keyIdentifier,
          e = /^U\+/.test(e)
            ...
            : e;
        return n[e] || (1 < e.length ? j.hyphenate(e) : e.toLowerCase());
      }
      function f(t, e, n, i) {
        var r,
          s = Y._focused;
        if (
          ...
          1 < e.length && (r = j.camelize(e)) in c)
        ) {
          c[r] = t;
          var a = Bt && Bt.agent;
          if ("meta" === r && a && a.mac)
      ...
      update: function (e) {
        if (this.running) {
          ...
          this.responds("update") &&
            this.emit("update", new j({ progress: e, factor: n })),
    ...
    ht = function (n) {
      ...
      return (
        i.open((n.method || "get").toUpperCase(), n.url, j.pick(n.async, !0)),
    ...
    lt = new (function () {
      ...
      var k = {
        ...
        r = ut.getContext(1, 1, { willReadFrequently: !0 });
      r &&
        (j.each(k, function (t, e) {
          var n = "darken" === e,
            i = !1;
          r.save();
          try {
  ...
  function pt(r, t, e) {
    ...
    return (
      ...
      j.each(ft, function (t) {
        var e = t.get,
          n = t.type,
          i = r[e]();
        (t.exportFilter ? !t.exportFilter(r, i) : a && j.equals(a[e](), i)) ||
          ("color" !== n ||
            null == i ||
  ...
  function Et(t) {
    (t = t && t.match(/\((?:["'#]*)([^"')]+)/)),
      (t = t && t[1]),
      (t = t && X[T ? t.replace(T.location.href.split("#")[0] + "#", "") : t]);
  ...
  function Lt(t, e, n) {
    ...
    return (
      ...
      n && ((X = {}), a && j.pick(e.applyMatrix, l) && a.matrix.apply(!0, !0)),
      a
    );
  }
  function Nt(i, r, s) {
    ...
    function t(t) {
      try {
        ...
        (Bt = a),
          (o = Lt(e, r, !0)),
          (r && !1 === r.insert) || s._insertItem(R, o);
        var n = r.onLoad;
        n && n(o, t);
      } catch (t) {
        h(t);
  ...
  (G = {
    ...
    (j.exports.PaperScript = function () {
      var t,
        e,
        n,
        i = this,
      ...
      r ||
        ...
        (n = function (t) {
          ...
          var Ot,
            ...
            Et = Mt("class enum extends super const export import"),
            Lt = Mt(
              "implements interface let package private protected public static yield"
            ),
            Nt = Mt("eval arguments"),
            Bt = Mt(
              ...
              return t < 65
                ...
                : t < 91 ||
                    (t < 97
                      ? 95 === t
                      : t < 123 ||
                        (170 <= t && jt.test(String.fromCharCode(t))));
            }),
          ...
          function xe() {
            ...
            switch (i) {
              ...
              default:
                var u = p,
                  l = Pe();
                if (i === M && "Identifier" === l.type && de(ft)) {
          ...
          function Pe(t, e) {
            ...
            if (t || g !== lt) return n;
            var i = le(n);
            for (i.expressions = [n]; de(lt); ) i.expressions.push(Te(e));
          ...
          function Ee(t, e) {
            g === M ? (t.id = Ne()) : e ? ve() : (t.id = null), (t.params = []);
            var n = !0;
      ...
      function h() {
        j.each(A && A.getElementsByTagName("script"), a);
      }
      return (
        E.inject(s),
        O.inject(s),
        C.inject(s),
        T &&
          ("complete" === A.readyState ? setTimeout(h) : N.add(T, { load: h })),
        {
          compile: y,
          execute: o,
          load: function (t) {
